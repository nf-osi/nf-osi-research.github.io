...
- making it clear what data formats are preferred for sharing.
These specifications should lead to higher-impact data, encouraging sharing of interoperable formats that make data more likely to be reused (and cited). 
...
The data-sharing specifications highlighted in this document have been informed by several members in the research community, using their opinions solicited through an open RFC.
First are requirements already established by the NF-OSI funding organizations, which typically apply to types of data which have clear "reusability" value and for which there are well defined strategies for sharing (e.g. sequencing data).
